...
<p align="center">
<a href="https://github.com/OpenDataGIS/ckan-docker-iepnb"><img src="https://img.shields.io/badge/Docker%20CKAN-2.9.12-brightgreen" alt="CKAN Versions"></a>
...
| 2.9.12 | custom image | `ghcr.io/opendatagis/ckan-iepnb:ckan-2.9.12` | Latest security backport: [`2.9.12`](https://github.com/derilinx/ckan-backports) |
...
| --- | --- | --- | --- | --- | --- |
| [`docker-compose.yml`](/docker-compose.yml) / [`docker-compose.apache.yml`](/docker-compose.apache.yml) | CKAN 2.9.12 | custom image | [`opendatagis/ckan-docker-iepnb:ckan-2.9.12`](https://github.com/OpenDataGIS/ckan-docker-iepnb/pkgs/container/ckan-iepnb) | 800 MB |   Custom Dockerfile: [`ckan/Dockerfile`](/ckan/Dockerfile) |
...
| Extension   | [ckanext-xloader](https://github.com/mjanez/ckanext-xloader)                              | 1.0.1-stable       | Completed                    | ✔️      | ✔️      | Stable installation, a replacement for DataPusher because it offers ten times the speed and more robustness                                                                                                                                                                                                                                                                  |
...
| Extension   | [ckanext-geoview](https://github.com/ckan/ckanext-geoview)                              | 0.2.0      | Completed                    | ✔️      | ✔️      | Stable installation.                                                                                                                                                                                                                                                                                                                                                    |
...
| Extension   | [ckanext-dcat](https://github.com/mjanez/ckanext-dcat)                                  | v1.8.0       | Completed                    | ✔️      | ✔️      | Stable installation, include DCAT-AP 2.1 profile compatible with GeoDCAT-AP.                                                                                                                                                                                                                                                                                            |
...
| Extension   | [ckanext-resourcedictionary](https://github.com/mjanez/ckanext-resourcedictionary) | v1.0.2        | Completed                    | ✔️      | ✔️      | Stable installation. This extension extends the default CKAN Data Dictionary functionality by adding possibility to create data dictionary before actual data is uploaded to datastore.                                                                                                                                                                                 |
...
| Extension    | [ckanext-schemingdcat](https://github.com/mjanez/ckanext-schemingdcat)                                    | v3.2.2        | Completed | ✔️      | ✔️       | Stable installation for scheming vanilla version, DCAT improved, facet and filter for custom [ckanext-scheming](https://github.com/mjanez/ckanext-scheming)                                                                                                                                                                         |
| Extension    | [ckanext-iepnb](https://github.com/OpenDataGIS/ckanext-iepnb)                                    | v2.3.0        | Completed | ✔️      | ✔️       | Stable installation, only theme extension.                                                                                                                                                                           |
| Extension    | [ckanext-sparql_interface](https://github.com/OpenDataGIS/ckanext-sparql_interface)                                    | 2.0.3-iepnb         | Completed | ✔️      | ✔️       | Stable installation, SPARQL Interface for [datos.iepnb.es/sparql](https://datos.iepnb.es/sparql)                                                                                                                                                                           |
