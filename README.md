...
| Extension    | [ckanext-iepnb](https://github.com/OpenDataGIS/ckanext-iepnb)                                    | 2.0.2        | Completed | ✔️      | ✔️       | Stable installation, only theme extension.                                                                                                                                                                           |
| Extension    | [ckanext-iepnb](https://github.com/OpenDataGIS/ckanext-sparql_interface)                                    | 2.0.2        | Completed | ✔️      | ✔️       | Stable installation, SPARQL Interface for [datos.iepnb.es/sparql](https://datos.iepnb.es/sparql)                                                                                                                                                                           |
